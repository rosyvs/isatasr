...
mic_matching_file = os.path.join('configs', 'mic_matching_r1g11d1pm.txt')
...
for new_sess, ref_sess, offset in sesslist:
    ...
    new_audio = AudioSegment.from_file(os.path.join(new_sesspath,f'{new_sess}.wav'))
    ...
    for s, row in new_segs.iterrows():
        ...
        seg_audio = seg_audio.set_frame_rate(16000)
