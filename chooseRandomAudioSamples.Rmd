...
packages <- c('sjPlot', 'reshape2', 'magrittr', 'data.table', 'gridExtra', 'ggplot2','stringr','readxl','tidyverse', 'dplyr','tidyr','strex','tibble','chron','lubridate','anytime','hms','stringr')
ipak(packages)
...
sample <- bind_rows(sample)%>% arrange(Name.of.File) %>% write.csv(paste0('../annotation/samples_focussed_5inCenter_2022-01-26_', k, '.csv'))
}
```